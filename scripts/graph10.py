...
if __name__ == "__main__":
    plot_generator = PlotGenerator(
        title="Accessibility osm209771454 6.00-24:00"  # Plot title
    )
    ...
    plot_generator.save_data_to_excel(r"C:\\Users\\geosimlab\\Documents\\Igor\\experiments\\plot_data10.xlsx")
