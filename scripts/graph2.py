...
if __name__ == "__main__":
    plot_generator = PlotGenerator(
        ...
        title="Accessibility Gesher"  # Plot title
    )

    # Add lines from the specified directory with specific transfer counts
    plot_generator.add_line(
        base_dir=r"C:\\Users\\geosimlab\\Documents\\Igor\\experiments\\gesher_from_fix-time_0_0\\",        
        min_transfer = 0, max_transfer = 2,
        label="Gesher (from, fix-time, transfers (0-0)) "  # Set line label
    )

    plot_generator.add_line(
        base_dir=r"C:\\Users\\geosimlab\\Documents\\Igor\\experiments\\gesher_from_fix-time_1_1\\",        
        min_transfer = 0, max_transfer = 2,
        label="Gesher (from, fix-time, transfers (1-1)) "  # Set line label
    )

    plot_generator.add_line(
        base_dir=r"C:\\Users\\geosimlab\\Documents\\Igor\\experiments\\gesher_from_fix-time_2_2\\",        
        min_transfer = 0, max_transfer = 2,
    ...
    plot_generator.save_data_to_excel(r"C:\\Users\\geosimlab\\Documents\\Igor\\experiments\\plot_data2.xlsx")
