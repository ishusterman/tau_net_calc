...
<qgis version="3.44" styleCategories="Symbology">
  ...
  <renderer-v2 type="graduatedSymbol" graduatedMethod="GraduatedColor" attr="__FIELD__">
    ...
    <!-- Базовый символ (обязателен для QGIS 3.44) -->
    <source-symbol>
    ...
    <symbols>
      ...
      <symbol type="fill" name="0" clip_to_extent="1" alpha="1">
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option name="color" value="63,34,0,255"/>
          <Option name="outline_color" value="35,35,35,0"/>
          <Option name="outline_width" value="0"/>
        </layer>
      </symbol>
      ...
      <symbol type="fill" name="1" clip_to_extent="1" alpha="1">
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option name="color" value="127,101,71,255"/>
          <Option name="outline_color" value="35,35,35,0"/>
          <Option name="outline_width" value="0"/>
        </layer>
      </symbol>
      ...
      <symbol type="fill" name="2" clip_to_extent="1" alpha="1">
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option name="color" value="189,170,147,255"/>
          <Option name="outline_color" value="35,35,35,0"/>
          <Option name="outline_width" value="0"/>
        </layer>
      </symbol>
      ...
      <symbol type="fill" name="3" clip_to_extent="1" alpha="1">
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option name="color" value="244,245,244,255"/>
          <Option name="outline_color" value="35,35,35,0"/>
          <Option name="outline_width" value="0"/>
        </layer>
      </symbol>
      ...
      <symbol type="fill" name="4" clip_to_extent="1" alpha="1">
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option name="color" value="138,185,156,255"/>
          <Option name="outline_color" value="35,35,35,0"/>
          <Option name="outline_width" value="0"/>
        </layer>
      </symbol>
      ...
      <symbol type="fill" name="5" clip_to_extent="1" alpha="1">
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option name="color" value="65,125,89,255"/>
          <Option name="outline_color" value="35,35,35,0"/>
          <Option name="outline_width" value="0"/>
        </layer>
      </symbol>
      ...
      <symbol type="fill" name="6" clip_to_extent="1" alpha="1">
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option name="color" value="0,66,26,255"/>
          <Option name="outline_color" value="35,35,35,0"/>
          <Option name="outline_width" value="0"/>
        </layer>
      </symbol>
    ...
    <!-- Диапазоны (Python подставляет LOW/UP) -->
    <ranges>
      ...
      <range symbol="6" render="true" label="LOW7 – UP7" lower="LOW7" upper="UP7"/>
    </ranges>
