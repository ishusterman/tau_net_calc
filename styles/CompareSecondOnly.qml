...
<qgis styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" version="3.40.4-Bratislava" autoRefreshMode="Disabled" autoRefreshTime="0" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" minScale="100000000" simplifyLocal="1" symbologyReferenceScale="-1">
  ...
  <renderer-v2 enableorderby="0" graduatedMethod="GraduatedColor" symbollevels="0" type="graduatedSymbol" forceraster="0" referencescale="-1" attr="Duration">
    <ranges>
      <range lower="492.000000000000000" upper="2700.000000000000000" label="Accessible with schedule-based only" symbol="0" render="true" uuid="{b0b6e623-69ce-4938-a491-68ca45b5ad3e}"/>
    </ranges>
    <symbols>
      <symbol force_rhr="0" alpha="1" type="fill" name="0" frame_rate="10" clip_to_extent="1" is_animated="0">
        ...
        <layer locked="0" pass="0" enabled="1" class="SimpleFill" id="{905a2731-0eac-40eb-8def-198a6b671d9d}">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="0,219,225,255,hsv:0.50461111111111112,1,0.88368047608148315,1" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
    ...
    <source-symbol>
      <symbol force_rhr="0" alpha="1" type="fill" name="0" frame_rate="10" clip_to_extent="1" is_animated="0">
        ...
        <layer locked="0" pass="0" enabled="1" class="SimpleFill" id="{905a2731-0eac-40eb-8def-198a6b671d9d}">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="63,207,255,255,hsv:0.54127777777777775,0.75339894712748912,1,1" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
